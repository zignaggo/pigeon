  ...
  return (
    <div className="absolute inset-0 z-40 flex flex-col justify-end">
      <div
        ...
        style={{ background: "rgba(10,7,5,0.55)", animation: "pmScrim .25s ease" }}
      />
      <div
        className="bg-card relative px-5 pb-7 pt-2.5 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]"
        style={{ borderRadius: "26px 26px 0 0", animation: "pmSheetUp .32s cubic-bezier(.4,0,.2,1)" }}
      >
        ...
        <div className="text-center">
          ...
          <div className="text-foreground text-[19px] font-extrabold" style={{ letterSpacing: -0.4 }}>
            Ana Martins
          </div>
          <div className="text-muted-foreground mt-0.5 text-xs" style={{ fontFamily: MONO }}>
        ...
        <div className="bg-background mt-4 flex flex-col gap-2.5 rounded-[14px] px-3.5 py-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="text-foreground text-[13px] font-bold">Quer te enviar 3 arquivos</div>
              <div className="text-muted-foreground text-[11.5px]" style={{ fontFamily: MONO }}>
                48,2 MB no total
              </div>
            </div>
          </div>
        ...
        <div
          ...
          style={{ background: "color-mix(in oklab, var(--chart-3) 16%, transparent)", color: "var(--chart-3)" }}
        >
        ...
        <div className="mt-4 flex gap-3">
          ...
          <button
            ...
            style={{ flex: 1.7, boxShadow: "0 8px 20px color-mix(in oklab, var(--primary) 40%, transparent)" }}
          >
            Aceitar e receber
          </button>
        </div>
