...
export const PEERS: Peer[] = [
  { id: "ana", name: "Ana Martins", device: "MacBook da Ana", kind: "laptop", status: "online", distance: "mesma sala", tint: "coral", mono: initialsOf("Ana Martins") },
  { id: "bruno", name: "Bruno", device: "Galaxy S24", kind: "phone", status: "online", distance: "wi-fi · 2 m", tint: "sun", mono: initialsOf("Bruno") },
  { id: "ceci", name: "Cecília", device: "iPad Pro", kind: "tablet", status: "online", distance: "wi-fi", tint: "mint", mono: initialsOf("Cecília") },
  { id: "diego", name: "Diego Fernandes", device: "ThinkPad-T14", kind: "laptop", status: "idle", distance: "wi-fi", tint: "sky", mono: initialsOf("Diego Fernandes") },
  { id: "elena", name: "Elena", device: "PC-do-Escritório", kind: "desktop", status: "online", distance: "ethernet", tint: "lilac", mono: initialsOf("Elena") },
];

export type MockFile = { name: string; ext: string; size: string; badge?: string };
