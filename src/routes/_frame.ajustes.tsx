      ...
      <div className="pm-screen flex-1 overflow-auto px-4 pb-5 pt-1">
        ...
        <PMCard>
          <div className="flex items-center gap-3.5 px-[15px] py-4">
            ...
            <button
              type="button"
              className="border-border bg-card text-foreground rounded-[14px] border px-3.5 py-2 text-[12.5px] font-semibold"
            >
              Editar
            </button>
          </div>
        ...
        <PMCard>
          <Row
            ...
            control={<PMToggle on ariaLabel="Visível na rede" />}
          />
          <Row
            label="Exigir aprovação"
            desc="Confirmar cada pedido de conexão"
            control={<PMToggle on ariaLabel="Exigir aprovação" />}
            isLast
          />
        </PMCard>
        ...
        <PMCard>
          ...
          <Row
            ...
            control={<PMToggle on={false} ariaLabel="Abrir após receber" />}
          />
          <Row
            label="Notificar com som"
            control={<PMToggle on ariaLabel="Notificar com som" />}
            isLast
          />
        </PMCard>
        ...
        <PMCard>
          <Row
            ...
            desc="AES-256 · ativada por padrão"
            control={<PMToggle on ariaLabel="Criptografia ponta a ponta" />}
          />
          <Row
            label="Dispositivos confiáveis"
            desc="5 dispositivos salvos"
            control={Chevron}
            isLast
          />
        </PMCard>
